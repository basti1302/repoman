 ...
 */
function GitHub(user, pass, ready) {
  ...
  var dotfile = Dotfile('repomanrc');
  var oauthPromise = new BluePromise(function(s, f){
  ...
  oauthPromise.then(ready, function error(){
    ready();
  });
}
